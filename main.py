...
def instructions():
    ...
    while loop:
        ...
        draw_text('• At each destination, you will meet a student. Press the space bar and a new riddle will pop up.',20,colors['light blue'],screen,521,174,True, 'Game Font.ttf')
        ...
        draw_text('wrong destination aswell. If your points run out, the game is over.',20,colors['light blue'],screen,378,480,True, 'Game Font.ttf')
